...
namespace Budget.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                //if(model.Code == null) {
                    ...
                    //Household h = new Household { Name = model.Name };
                    //db.Households.Add(h);
                    //db.SaveChanges();
                //}
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UserAccount(string userId, string userName, string name)
        {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    var user = new ApplicationUser { Email = loginInfo.Email, UserName = loginInfo.Email, Name = loginInfo.DefaultUserName };
